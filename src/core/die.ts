...
//        press-band rule this app already tracks (SERVICE_BANDS), then
//        gets tuned per tool from its wear history.
 ...
 *  the die's governing press-band rule (SERVICE_BANDS) and L3 at 10× L2.
 ...
 *  bands as the tonnage service rule). */
